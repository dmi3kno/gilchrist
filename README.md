...
Gompertz distribution is just an exponential Q-transformed with
`log1p()` function.
...
$$Q(u)=\frac{1}{\text{b}}\left[\text{log1p}(\left[\frac{1}{ {\eta}}\left[-\ln(1- {u} )\right]\right])\right]$$
...
<img src="man/figures/README-unnamed-chunk-37-1.png"
style="width:100.0%" />
...
<img src="man/figures/README-unnamed-chunk-40-1.png"
style="width:100.0%" />

### DUS-transformation

Finally, we can apply the DUS-transformation proposed by Kumar, Singh,
and Singh (2015). DUS is a particular case of a more general Alpha-Power
transformation (for $\alpha=e$).
...
<img src="man/figures/README-unnamed-chunk-42-1.png"
style="width:100.0%" />
...
as well be called DUS Type II transformation. Again KM is a special case
of a more general Alpha Power Type II (reflected and shifted AP1)
transformation with $\alpha=e$
...
<img src="man/figures/README-unnamed-chunk-44-1.png"
style="width:100.0%" />
...
<img src="man/figures/README-unnamed-chunk-54-1.png"
style="width:100.0%" />
